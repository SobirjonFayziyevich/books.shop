exports.member_type_enums = ["USER", "ADMIN", "COMPANY" ];
exports.member_status_enums = ["ONPAUSE", "ACTIVE", "DELETED"];
exports.ordernary_enums = ["Y", "N"]; 

exports.member_address_enums = ["Nyu York", "Seoul", "Uzbekistan", "Russian", "Canada"];

exports.product_collection_enums = ["story book", "romantic book", "textbook", "newspapers", "etc"];
